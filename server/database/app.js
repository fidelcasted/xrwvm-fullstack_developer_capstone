...
app.get('/fetchDealers', async (_req, res) => {
    try {
      ...
      res.status(500).json({ error: 'Error fetching dealerships' }); // Handle any errors and send an appropriate response
    }
  });
...
app.get('/fetchDealers/:state', async (req, res) => {
    ...
    try {
      ...
      res.status(500).json({ error: 'Error fetching dealerships by state' }); // Handle any errors and send an appropriate response
    }
  });
